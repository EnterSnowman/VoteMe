 ...
 */
class AllVotesFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            ...
            recyclerView.adapter = AllVotesRecyclerViewAdapter(DummyContent.ITEMS, mListener)
        }
        return view
    }
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onAllVotesListFragmentInteraction(item: DummyItem)
    }
